 ...
 * @author Admin
 */
public class DangKiFrm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            new NguoiChoiDAO().themNguoiChoi(taiKhoan, matKhau, nickName);
            int rs = JOptionPane.showConfirmDialog(rootPane, "Đăng kí tài khoản thành công, nhấn Yes để chuyển đến đăng nhập!");
            if(rs==JOptionPane.OK_OPTION){
                this.setVisible(false);
                new DangNhapFrm(taiKhoan,matKhau).setVisible(true);
            }
